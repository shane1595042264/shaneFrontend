  ...
  return (
    <Shell title="You need access">
      ...
      <textarea
        ...
        className="mt-1.5 block w-full resize-y rounded-md border border-white/15 bg-transparent px-3 py-2 text-sm placeholder:text-gray-400 focus:border-white/40 focus:outline-none"
      />
      {submitError && (
