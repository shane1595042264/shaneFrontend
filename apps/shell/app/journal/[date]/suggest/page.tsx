  ...
  if (authLoading || loading) {
    return (
      <div className="mx-auto max-w-5xl px-4 py-8" aria-busy={true}>
        <div role="status" aria-label="Loading suggestion editor">
          <span className="sr-only">Loading suggestion editor…</span>
          <div className="h-3 w-28 rounded bg-white/8 animate-pulse" />
          <div className="mt-3 mb-1 h-7 w-64 rounded bg-white/8 animate-pulse" />
          <div className="mb-2 h-3 w-full max-w-2xl rounded bg-white/8 animate-pulse" />
          <div className="mb-4 h-3 w-2/3 max-w-lg rounded bg-white/8 animate-pulse" />
          ...
          <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:gap-2">
            <div className="h-11 w-full rounded bg-white/8 animate-pulse sm:w-36" />
